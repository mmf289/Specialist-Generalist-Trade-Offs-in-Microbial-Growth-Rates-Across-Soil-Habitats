...
abund.data = read.csv("/Users/mfoley2/Library/CloudStorage/OneDrive-UniversitédeLausanne/PhD/desktop/dissertation/tube_level_counts_16S.csv",header = TRUE)
...
###NRI NTI analysis
tree<-read.newick("/Users/mfoley2/Documents/growth ecology paper/NRI NTI analysis/DRIP16S_seqs_2x2.fa.aln.tre")
...
ses.mntd.out <- ses.mntd(picCleanComm, 
                       cophenDist, 
